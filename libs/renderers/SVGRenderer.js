...
THREE.SVGRenderer = function () {
	...
	function renderSprite( v1, element, material ) {
		...
		var scaleXXX = element.scaleXX.x * _svgWidthHalf;
		var scaleXXY = element.scaleXX.y * _svgHeightHalf;

		_svgNode = getRectNode( _rectCount ++ );

		_svgNode.setAttribute( 'x', v1.x - ( scaleXXX * 0.5 ) );
		_svgNode.setAttribute( 'y', v1.y - ( scaleXXY * 0.5 ) );
		_svgNode.setAttribute( 'width', scaleXXX );
		_svgNode.setAttribute( 'height', scaleXXY );
