...
THREE.EditorControls = function ( object, domElement ) {
	...
	this.focus = function ( target, frame ) {
		...
		var scaleXX = new THREE.Vector3();
		target.matrixWorld.decompose( center, new THREE.Quaternion(), scaleXX );

		if ( frame && target.geometry ) {

			scaleXX = ( scaleXX.x + scaleXX.y + scaleXX.z ) / 3;
			center.add(target.geometry.boundingSphere.center.clone().multiplyScalar( scaleXX ));
			var radius = target.geometry.boundingSphere.radius * ( scaleXX );
