	...
	this.panCamera = (function() {
		...
		return function () {
			...
			if ( mouseChange.lengthSq() ) {
				...
				// scaleXX movement to keep clicked/dragged position under cursor
				var scaleXX_x = ( _this.object.right - _this.object.left ) / _this.object.zoom;
				var scaleXX_y = ( _this.object.top - _this.object.bottom ) / _this.object.zoom;
				mouseChange.x *= scaleXX_x;
				mouseChange.y *= scaleXX_y;
